    ...
    public function list()
    {
        ...
        return Datatables::of($grupo)
            ->addColumn('action', function($grupo) {
                ...
                // </div>';
                  return '<div class="row">
                    <a href="extracurricular/calificacion/agregar/' . Auth::user()->empleado->escuela->departamento->depClave . '/' . $grupo->id . '" class="button button--icon js-button js-ripple-effect" title="Calificaciones" >
                        <i class="material-icons">assignment_turned_in</i>
                    </a>
                </div>';
            })

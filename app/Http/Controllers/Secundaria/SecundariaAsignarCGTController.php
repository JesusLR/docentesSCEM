...
class SecundariaAsignarCGTController extends Controller
{
    ...
    public function getSecundariaInscritoCursos(Request $request, $periodo_id, $programa_id, $plan_id, $cgt_id)
    {
        if($request->ajax()){
            ...
            // llama al procedure 
            $resultado_array =  DB::select("call procSecundariaInscritoHayDatos(".$periodo_id.", ".$programa_id.", '".$plan_id."', ".$cgt_id.",".$gadroGrupo[0]->cgtGradoSemestre.",'".$gadroGrupo[0]->cgtGrupo."')");

...
class SecundariaRelacionMaestrosACDController extends Controller
{
    ...
    */
    private static function buscarGrupos($request) {
      ...
      return Secundaria_grupos::with(['secundaria_empleado', 'plan.programa.escuela', 'periodo', 'secundaria_inscritos.curso.cgt'])
      ...
      ->whereHas('secundaria_inscritos.curso.cgt',static function($query) use ($request) {

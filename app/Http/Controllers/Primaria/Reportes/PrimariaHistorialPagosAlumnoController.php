...
class PrimariaHistorialPagosAlumnoController extends Controller
{
    //
    ...
    public function reporte() {
    	return view('primaria.reportes.historial_pagos_alumno.create');
    }
    ...
    */
    ...
    public function imprimirPDF($pagos, $alumno) {
        ...
        $pdf = PDF::loadView('reportes.pdf.primaria.historial_pagos_alumno.'. $nombreArchivo, [
          "alumno" => $alumno,
          "pagos" => $pagos,

    ...
    $("input[name=gpoACD]").change(function(){
        if ($(this).is(':checked') ) {
            ...
            $("#materia_id").change( event => {
                ...
                $.get(base_url+`/bachiller_grupo_seq/materiaComplementaria/${event.target.value}/${plan_id}/${periodo_id}/${gpoSemestre}`,function(resACD,sta){
            ...
            $("#periodo_id").change( event => {
                ...
                $("#gpoMatComplementaria").empty();
                $("#gpoMatComplementaria").append(`<option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>`);
                $.get(base_url+`/bachiller_grupo_seq/materiaComplementaria/${materia_id}/${plan_id}/${event.target.value}/${gpoSemestre}`,function(resACD,sta){
                    resACD.forEach(materiaACD => {
                        $("#gpoMatComplementaria").append(`<option value="${materiaACD.gpoMatComplementaria}">${materiaACD.gpoMatComplementaria}</option>`);
                    });
                });
            ...
            $("#plan_id").change( event => {
                ...
                $("#gpoMatComplementaria").empty();
                $("#gpoMatComplementaria").append(`<option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>`);
                $.get(base_url+`/bachiller_grupo_seq/materiaComplementaria/${materia_id}/${event.target.value}/${periodo_id}/${gpoSemestre}`,function(resACD,sta){
                    resACD.forEach(materiaACD => {
                        $("#gpoMatComplementaria").append(`<option value="${materiaACD.gpoMatComplementaria}">${materiaACD.gpoMatComplementaria}</option>`);
                    });
                });

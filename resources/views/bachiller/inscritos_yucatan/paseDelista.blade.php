...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_grupo_yucatan')}}" class="breadcrumb">Lista de grupos</a>
      ...
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_inscritos.asistencia_alumnos', 'method' => 'POST']) !!}
        <div class="card ">
          ...
          <span class="card-title">PASE DE LISTA DEL GRUPO #{{$grupo->id}}</span>
            ...
            <div class="row">
                <div class="col s12">
                    <span>Materia complementaria: <b>{{$grupo->gpoMatComplementaria}}</b></span>
                </div>
            </div>
            @endif
            <div class="row">
...
@include('bachiller.inscritos_yucatan.jsPaseDelista')

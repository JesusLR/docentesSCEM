...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_grupo_yucatan/'.$grupo->id.'/edit')}}" class="breadcrumb">Editar grupo</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['bachiller.bachiller_grupo_yucatan.update', $grupo->id])) }}
        <div class="card ">

...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_grupo_yucatan')}}" class="breadcrumb">Lista de Grupo</a>
    <a href="" class="breadcrumb">Horario</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['class' => 'formAgregarHorario', 'onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller_grupo_yucatan.agregarHorario', 'method' => 'POST']) !!}
            <div class="card ">
                <div class="card-content ">
                    <span class="card-title">CONSULTAR HORARIO DEL GRUPO #{{$bachiller_grupo->id}}</span>
                    ...
                    <div id="general">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <span>Materia complementaria: <b>{{$bachiller_grupo->gpoMatComplementaria}}</b></span>
                            </div>
                        </div>
                        @endif
    ...
    $(document).ready(function() {
        ...
        if (grupo_id != "" && grupo_id != null) {
            ...
            // "pageLength": 5,
                ...
                "ajax": {
                    "type" : "GET",
                    'url': base_url+"/api/bachiller_grupo_yucatan/horario/"+grupo_id,
                    beforeSend: function () {
        ...
        $('.btnAgregarHorario').on("click", function (e) {
            ...
            $.ajax({
                ...
                type: "POST",
                dataType: "JSON",
                url: base_url + "/bachiller_grupo_yucatan/verificarHorasRepetidas",
            })
        ...
        if (claveMaestro !== "" && claveMaestro !== null && periodoId !== "" && periodoId !== null) {
            $('#tbl-horario-bachiller_merida-admivo').dataTable({
                ...
                "ajax": {
                    "type" : "GET",
                    'url': base_url + "/api/bachiller_grupo_yucatan/horario_admin/" + claveMaestro + "/" + periodoId,
                    beforeSend: function () {

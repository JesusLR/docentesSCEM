...
@section('breadcrumbs')
    ...
    <a href="{{ url('bachiller_grupo_yucatan/'.$grupo->id.'/evidencia') }}" class="breadcrumb">Agregar evidencia</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_grupo_yucatan.guardar_actualizar_evidencia', 'method' => 'POST']) !!}
        <div class="card ">
          <div class="card-content ">
            ...
            {{-- GENERAL BAR--}}
            <div id="general">
                {{-- <input type="hidden" name="bachiller_grupo_merida_id" value="{{$grupo->id}}"> --}}
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        obtenerDatos($("#bachiller_grupo_merida_id").val(),$("#bachiller_mes_evaluacion_id").val())
        $("#bachiller_mes_evaluacion_id").change( event => {
            obtenerDatos($("#bachiller_grupo_merida_id").val(),event.target.value)
        });
     });
  </script>

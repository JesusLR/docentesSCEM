...
<div id="table-datatables">
    <br>
    {{-- <a id="listaAsistencia" class="btn-large waves-effect darken-3" target="_blank"  href="{{url('bachiller_inscritos_che/lista_de_asistencia/grupo/'.$grupo->id)}}">Lista asistencia
        <i class="material-icons left">picture_as_pdf</i>
    </a>
    <a href="{{route('bachiller.bachiller_asignar_grupo_chetumal.create')}}" class="btn-large waves-effect darken-3" type="button">Inscribir

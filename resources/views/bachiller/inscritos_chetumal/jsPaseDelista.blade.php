...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#fecha_asistencia").change( event => {
            ...
            $.get(base_url+`/bachiller_inscritos_seq/obtenerAlumnosPaseLista/${grupo_id}/${event.target.value}`,function(res,sta){
                var registros_guardados = res.bachiller_cch_asistencia.length;
                ...
                if(registros_guardados > 0){
                    ...
                    const data = res.bachiller_cch_asistencia;
        ...
        $.get(base_url+`/bachiller_inscritos_seq/obtenerAlumnosPaseLista/${grupo_id}/${fecha_asistencia}`,function(res,sta){
            var registros_guardados = res.bachiller_cch_asistencia.length;
            var alumnos_curso = res.cursosPaseLista.length;

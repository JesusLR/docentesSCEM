    ...
    <header>
      <div class="row">
        <div class="columns medium-6">
          ...
          <p><b>Consulta: </b> Del {{Utils::fecha_string($fechaInicio, $fechaInicio)}} al {{Utils::fecha_string($fechaFin, $fechaFin)}}</p>
        ...
        <table class="table">
          ...
          <tbody>
            @foreach ($alumnos as $item)
                <tr>
                  <td class="punteado" align="center" colspan="1" style="font-weight: 400;">{{$pos++}}</td>
                  <td class="punteado" align="center" colspan="1" style="font-weight: 400;">{{$item->aluClave}}</td>
                  <td class="punteado" style="font-weight: 400;">{{$item->alumno}}</td>

                  @php
                      $faltas = DB::select("SELECT COUNT(*) total_faltas
                      FROM bachiller_asistencia
                      INNER JOIN bachiller_inscritos AS bachiller_inscritos ON bachiller_inscritos.id = bachiller_asistencia.asistencia_inscrito_id
                      ...
                      AND bachiller_asistencia.asistencia_inscrito_id = $item->bachiller_inscrito_id
                      AND bachiller_asistencia.estado = 'F'
                      AND bachiller_asistencia.fecha_asistencia >= '".$fechaInicio."'
                      AND bachiller_asistencia.fecha_asistencia <= '".$fechaFin."'
                      AND bachiller_inscritos.deleted_at IS NULL
                      AND cursos.deleted_at IS NULL
                      AND alumnos.deleted_at IS NULL");
                  @endphp

                  <td class="punteado" align="center" style="font-weight: 400;">

<script type="text/javascript">
    $(document).ready(function() {
            ...
            $.get(base_url+`/primaria_planeacion_docente/getGrupo/${periodo_id}/${programa_id}/${event.target.value}/${gpoGrado}`,function(res,sta){
                res.forEach(element => {
                    if(element.matClaveAsignatura == "" || element.matClaveAsignatura == null || element.matClaveAsignatura == "null"){
                        ...
                        $("#primaria_grupo_id").append(`<option value=${element.id}>${element.gpoGrado}-${element.gpoClave}-${element.gpoTurno}, Materia: ${element.matClave}-${element.matNombre}, Asignatura: ${element.matClaveAsignatura}-${element.matNombreAsignatura}</option>`);
        ...
        var periodo_id = $("#periodo_id").val();
            ...
            $.get(base_url+`/primaria_planeacion_docente/getGrupo/${periodo_id}/${programa_id}/${plan_id}/${gpoGrado}`,function(res,sta){
                res.forEach(element => {
                    if(element.matClaveAsignatura == "" || element.matClaveAsignatura == null || element.matClaveAsignatura == "null"){
                        $("#primaria_grupo_id").append(`<option value=${element.id}>${element.gpoGrado}-${element.gpoClave}-${element.gpoTurno}, Materia: ${element.matClave}-${element.matNombre}</option>`);

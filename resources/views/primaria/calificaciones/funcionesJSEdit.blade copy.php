                        ...
                        const tableData = data_create.map(function(element){
                            ...
                            return (
                                `<tr>
                                    ...
                                    <td><input type="number" onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" id='evidencia1' name='evidencia1[]' step="0.01"  lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" id='evidencia2' name='evidencia2[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" id='evidencia3' name='evidencia3[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" id='evidencia4' name='evidencia4[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" id='evidencia5' name='evidencia5[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" id='evidencia6' name='evidencia6[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" id='evidencia7' name='evidencia7[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" id='evidencia8' name='evidencia8[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" id='evidencia9' name='evidencia9[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" id='evidencia10' name='evidencia10[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>

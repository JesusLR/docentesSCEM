    ...
    $(document).ready(function() {
        ...
        $.get(base_url+`/api/departamentos/${ubicacion_id}`,function(res,sta){
            ...
            res.forEach(element => {
                ...
                $("#departamento_id").append(`<option value=${element.id} ${selected}>${element.depNombre}</option>`);
            });
            ...
            $.get(base_url+`/api/escuelas/${departamento_id}`,function(res,sta){
                res.forEach(element => {
                    ...
                    $("#escuela_id").append(`<option value=${element.id} ${selected}>${element.escNombre}</option>`);
                });

...
@section('template_title')
    Secundaria reporte calificaciones por grupo-materia
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'secundaria_reporte.calificacion_por_materia.imprimirDesdeGrupos', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">REPORTE DE CALIFICACIONES POR GRUPO-MATERIA #{{$secundaria_inscritos[0]->grupo_id}}</span>
            ...
            <div id="general">
                ...
                <div class="row">
                    <div class="col s12">
                        <span>Grupo ACD: <b>{{$secundaria_inscritos[0]->gpoMatComplementaria}}</b></span>
                    </div>
                </div>
                @endif
                <div class="row">

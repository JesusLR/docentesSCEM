    ...
    <header>
      <div class="row">
        <div class="columns medium-6">
          ...
          <h4 style="margin-top:0px; margin-bottom: 10px;">ESCUELA MODELO SECUNDARIA</h4>
          ...
          <p><b>Período:</b> {{ \Carbon\Carbon::parse($inscritos[0]->fecha_inicio)->format('d/m/Y')}} al {{ \Carbon\Carbon::parse($inscritos[0]->fecha_fin)->format('d/m/Y')}}</p>
          <p><b>Nivel:</b> {{$inscritos[0]->progClave}} ({{$inscritos[0]->planClave}}) {{$inscritos[0]->progNombre}} {{$inscritos[0]->gpoGrado}}° Grupo: {{$inscritos[0]->gpoClave}} </p>
          <p><b>Docente:</b> {{$inscritos[0]->empNombre}} {{$inscritos[0]->empApellido1}} {{$inscritos[0]->empApellido2}} ({{$inscritos[0]->empleados_id}})</p>
          <p><b>Materia:</b> {{$inscritos[0]->matClave}} {{$inscritos[0]->matNombre}}</p>
        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th align="center" style="font-weight: 400;">Calificación</th>

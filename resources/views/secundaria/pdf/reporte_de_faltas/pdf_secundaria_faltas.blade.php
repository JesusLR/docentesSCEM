    ...
    <header>
        <div class="row">
          <div class="columns medium-12">
              ...
              <p>Niv/Carr: {{$secundaria_inscritos[0]->escClave}} ({{$secundaria_inscritos[0]->planClave}}) {{$secundaria_inscritos[0]->escNombre}}</p>
              <p>Ubicac. : {{$secundaria_inscritos[0]->ubiClave}}-{{$secundaria_inscritos[0]->ubiNombre}}</p>
              <p>Materia: {{$secundaria_inscritos[0]->matClave}} {{$secundaria_inscritos[0]->matNombre}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Grado : {{$secundaria_inscritos[0]->gpoGrado}}° Grupo: {{$secundaria_inscritos[0]->gpoClave}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
              ...
              <tr>
                ...
                <td align="center" style="padding-top: 5px;">
                  ...
                  @if ($mes_a_consultar == "SEPTIEMBRE")
                    {{$itemInscritos->inscFaltasInjSep}}
                  @endif
                  @if ($mes_a_consultar == "OCTUBRE")
                    {{$itemInscritos->inscFaltasInjOct}}
                  @endif
                  @if ($mes_a_consultar == "NOVIEMBRE")
                    {{$itemInscritos->inscFaltasInjNov}}
                  @endif
                  @if ($mes_a_consultar == "DICIEMBRE")
                    {{$itemInscritos->inscFaltasInjDic}}
                  @endif
                  @if ($mes_a_consultar == "ENERO")
                    {{$itemInscritos->inscFaltasInjEne}}
                  @endif
                  @if ($mes_a_consultar == "FEBRERO")
                    {{$itemInscritos->inscFaltasInjFeb}}
                  @endif
                  @if ($mes_a_consultar == "MARZO")
                    {{$itemInscritos->inscFaltasInjMar}}
                  @endif
                  @if ($mes_a_consultar == "ABRIL")
                    {{$itemInscritos->inscFaltasInjAbr}}
                  @endif
                  @if ($mes_a_consultar == "MAYO")
                    {{$itemInscritos->inscFaltasInjMay}}
                  @endif
                  @if ($mes_a_consultar == "JUNIO")
                    {{$itemInscritos->inscFaltasInjJun}}
                  @endif

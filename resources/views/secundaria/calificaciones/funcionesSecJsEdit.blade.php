                ...
                if(res.mesEvidencia != ""){
                    ...
                    res.mesEvidencia.forEach(element => {
                        ...
                        if(element.mes == "ENERO"){
                            $("#secundaria_grupo_evidencia_id").append(`<option value=${element.id} ${selected}>DIEMBRE-ENERO</option>`);
                        }else{
                ...
                if(res != ""){
                    res.forEach(element => {
                        ...
                        /*if(element.numero_evidencias == 1){
                            ...
                            //Ocultar la columna de faltas para docentes de valladolid
            ...
            $.get(base_url+`/secundaria_calificacion/getCalificacionesAlumnos/${alumnoId}/${grupoId}`, function(res,sta) {
                ...
                res.forEach(element => {
                    ...
                    if(element.inscFaltasInjSep != null){
                        $faltasSep.innerHTML = `<input tabindex='2' id='faltaSep' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='${element.inscFaltasInjSep}' name='faltaSep[]' type='number' step='any' min='0' max="20" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase'>`; 

                    }else{
                        $faltasSep.innerHTML = `<input tabindex='2' id='faltaSep' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='' name='faltaSep[]' type='number' step='any' min='0' max="20" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase'>`; 
                    ...
                    //creamos la tabla
                        ...
                        if(numero_evidencias == 1){
                            ...
                            for(ocultarEvidencias=5; ocultarEvidencias < 14; ocultarEvidencias++){

...
Route::get('bachiller_calificacion_seq/getCalificacionesAlumnos/{id}/{grupoId}','Bachiller\BachillerCalificacionesSEQController@getCalificacionesAlumnos');
...
Route::post('bachiller_calificacion_seq/calificaciones','Bachiller\BachillerCalificacionesSEQController@update_calificacion')->name('bachiller.bachiller_calificacion_seq.calificaciones.update_calificacion');
...
Route::get('bachiller_inscritos_yuc/lista_de_asistencia/reporte/{grupo_id}', 'Bachiller\Reportes\BachillerListaDeAsistenciaController@reporte')->name('bachiller.bachiller_inscritos_yuc.reporte');
...
Route::post('bachiller_inscritos_yuc/lista_de_asistencia/reporte', 'Bachiller\Reportes\BachillerListaDeAsistenciaController@imprimirFaltas')->name('bachiller.bachiller_inscritos_yuc.imprimirFaltas');
